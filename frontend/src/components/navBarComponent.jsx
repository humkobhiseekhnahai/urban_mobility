...
import { ChevronDown, ChevronRight } from "lucide-react"; // Icons for arrow
    ...
    return (
        ...
        <div className="bg-white/10 backdrop-blur-md w-56 min-h-screen rounded-lg flex-shrink-0">
            ...
            <div className="h-12 w-full flex justify-start items-center space-x-2 text-lg font-medium text-gray-300 mb-3 pl-4 select-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 text-gray-100 stroke-current" strokeWidth="1.5" fill="currentColor">
                    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M20.5 5.5V22c0 .8-.7 1.5-1.5 1.5H5c-.8 0-1.5-.7-1.5-1.5V2c0-.8.7-1.5 1.5-1.5h10.5l5 5z"></path>
                    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M15.5.5V4c0 .8.7 1.5 1.5 1.5h3.5M7.5 11.5h9M7.5 13.5h9M7.5 15.5h9M7.5 17.5h5"></path>
                </svg>
            ...
            {/* Dashboard */}
            <div className="h-12 w-full flex justify-start items-center space-x-2 text-lg font-medium text-gray-300 mb-3 pl-4 select-none">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 text-gray-100 fill-current">
            ...
            <div className="w-full select-none">
                ...
                >
                    <div className="flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 text-gray-100 fill-current">
                            <path fill="currentColor" d="M26,21a5,5,0,0,0-4.9,4H7a4,4,0,0,1,0-8H25A6,6,0,0,0,25,5H10.9a5,5,0,1,0,0,2H25a4,4,0,0,1,2.84,6.83A4,4,0,0,1,25,15H7A6,6,0,1,0,7,27H21.1A5,5,0,1,0,26,21ZM6,9A3,3,0,1,1,9,6,3,3,0,0,1,6,9ZM26,29a3,3,0,1,1,3-3A3,3,0,0,1,26,29Z"></path>
                        </svg>
                        <span>Tracking</span>
                    </div>

                    {/* Rotating Arrow */}
                    {isTrackingOpen ? <ChevronDown className="w-5 h-5 text-gray-300" /> : <ChevronRight className="w-5 h-5 text-gray-300" />}
                </div>

                {/* Dropdown Menu */}
                {isTrackingOpen && (
                    <div className="ml-8 space-y-3 text-gray-300 text-sm">
                    <div className="cursor-pointer hover:text-white mb-8 flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="w-5 h-5 text-gray-100 fill-current">
                    ...
                    <div className="cursor-pointer hover:text-white flex items-center space-x-2 mb-8">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" className="w-5 h-5 text-gray-100 fill-current">
                            <g>
