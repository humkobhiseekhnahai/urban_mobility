            ...
            if (route && route.mapJsonContent) {
                try {
                    ...
                    const stops = parsedStops.map((stop) => {
                        const name = stop.busstop.split(",")[0].trim(); // Extract the first part as the stop name
                        const coordinates = stop.latlons.map(Number); // Convert lat/lon strings to numbers
                                ...
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span className="ml-2 px-2 py-1 bg-green-600/20 text-green-400 text-xs rounded-md">
                                                -13.5%
                                            </span>
                                        </div>
                                    </div>
