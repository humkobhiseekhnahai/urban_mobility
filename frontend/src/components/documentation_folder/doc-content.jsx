        ...
        <>
            ...
            >
                ...
                <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
                    Welcome to our documentation. This guide will help you get started with UPLYFT and understand its core concepts.
                </p>
            </motion.header>
            ...
            <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    id="what-is-our-platform"
                >
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight border-b border-gray-800 pb-2">
                        What is UPLYFT?
                    </h2>
                    <p className="text-gray-300 mt-4 leading-7">
                        UPLYFT is a smart platform that helps businesses deliver goods faster and cities reduce traffic jams. It uses real-time data like traffic, weather, and road closures to plan the best routes for trucks and improve public transport. By cutting delivery delays and easing congestion, it saves time, fuel, and lives. Whether it's avoiding accidents or balancing bus crowds, UPLYFT makes urban life smoother and safer.
                        It's the future of smarter cities and efficient logistics.
                    </p>
                </motion.div>
                ...
                <div id="getting-started">
                    ...
                    >
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">SignUP</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                        ...
                        <pre className="overflow-x-auto p-6 text-sm font-mono bg-gray-950/50 rounded-b-xl">
                            <code className="language-bash text-gray-100">
                                {`Go to the UPLYFT Login Page.\nEnter your credentials and click Login.\nAccess your dashboard and start optimizing!`}
                            </code>
                        </pre>
                    </motion.div>
                </div>
                ...
                <div id="next-steps">
                    <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-gray-200">Next Steps</h3>
                    <p className="text-gray-300 mt-4 leading-7">
                        After getting started, explore our documentation to learn more about UPLYFT's features and capabilities.
                    </p>
                </div>
            </section>
        </>
    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
                    Understanding the technical architecture of UPLYFT and how its components work together.
                </p>
            </motion.header>
            ...
            <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
                ...
                >
                    ...
                    <p className="text-gray-300 mt-4 leading-7">
                        UPLYFT is built on a microservices architecture that allows for scalability, resilience, and independent deployment of components. The system consists of several key services that communicate via APIs.
                    </p>
                </motion.div>

                <div>
                    <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-gray-200">Core Components</h3>
                ...
                <div>
                    ...
                    <p className="text-gray-300 mt-4 leading-7">
                        Data flows through the UPLYFT system in a structured manner, ensuring efficient processing and real-time insights.
                    </p>
                    ...
                    >
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Data Flow Diagram</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                        ...
                        <pre className="overflow-x-auto p-6 text-sm font-mono bg-gray-950/50 rounded-b-xl">
                            <code className="language-bash text-gray-100">
                                {`Data Sources → Data Collection → Processing → Analysis → Visualization → User Interface`}
                            </code>
                        </pre>
                    </motion.div>
                </div>
    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
                UPLYFT enhances urban mobility by providing real-time insights and tools for the general public. It improves traffic flow, reduces congestion, and enhances public transportation services.
                </p>
            </motion.header>
            ...
            <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
                ...
                >
                    ...
                    <div className="mt-6 space-y-6">
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 1: Accessing the Dashboard</h3>
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Accessing Dashboard</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 2: Viewing Bus Details</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Bus Details</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 3: Using Filters to Select Specific Days</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Using Filters</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 4: Exploring the Interactive Map</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Interactive Map</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 5: Understanding the Traffic Heat Map</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Traffic Heat Map</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 6: Checking Real-Time Weather Updates</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Weather Updates</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 7: Receiving Live Traffic Incident Alerts</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Traffic Incident Alerts</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
                    How UPLYFT optimizes delivery operations for logistics companies and delivery services.
                </p>
            </motion.header>
            ...
            <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
                ...
                >
                    ...
                    <p className="text-gray-300 mt-4 leading-7">
                        UPLYFT provides delivery partners with powerful tools to optimize routes, reduce delivery times, and improve overall efficiency.
                    </p>
                </motion.div>

                <div>
                    <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-gray-200">Features for Delivery Partners</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
                ...
                >
                    ...
                    <div className="mt-6 space-y-6">
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 1: Input Warehouse Address</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Warehouse Input</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 2: Add Delivery Stops</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Delivery Stops</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 3: Input Vehicle Details</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Vehicle Details</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 4: Route Optimization</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Route Optimization</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 5: ECO Mode for Climate Conservation</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">ECO Mode</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8"> Tools and features for bus operators to optimize routes, schedules, and passenger experience. </p>
            </motion.header>
            <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
                <motion.div
                    initial={{ opacity: 0 }}
                ...
                >
                    ...
                    <p className="text-gray-300 mt-4 leading-7">
                        UPLYFT helps bus operators improve service reliability, reduce wait times, and optimize fleet utilization through data-driven insights.
                    </p>
                </motion.div>

                <div>
                    <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-gray-200">Bus Operator Tools</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
                ...
                >
                    ...
                    <div className="mt-6 space-y-6">
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 1: Viewing Existing Routes</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Existing Routes</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 2: Creating New Routes</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Creating Routes</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 3: Route Optimization</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 4: Analyzing Passenger Data</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Passenger Analytics</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-white">Step 5: Managing Service Disruptions</h3>
                            <p className="text-gray-300 mt-2 leading-7">
                            ...
                            <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                                    <span className="text-sm font-medium text-gray-400">Service Disruptions</span>
                                    <motion.button
                                        type="button"
                                        whileTap={{ scale: 0.95 }}
                                        whileHover={{ scale: 1.05 }}
...
function LoadingSequenceContent() {
    ...
    <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
    Optimizing the order in which goods are loaded for efficient delivery operations.
    </p>
    </motion.header>
    <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
    <motion.div
    ...
    >
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    Our loading sequence planner uses the bin packing algorithm to optimize how packages are loaded into delivery vehicles, ensuring efficient unloading and space utilization.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">What is Bin Packing?</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        The bin packing algorithm is a smart way to load items into a truck, ensuring everything fits without overloading. It loads items in reverse delivery order for efficient unloading and packs them tightly to minimize wasted space, saving fuel and trips. This makes deliveries faster, safer, and more cost effective.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Algorithm Example</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Implementation Process</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Our implementation of the bin packing algorithm follows a systematic process to ensure optimal loading sequence.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Process Steps</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
...
function DeliveryRoutingContent() {
    ...
    >
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    UPLYFT implements a Genetic Algorithm (GA) for delivery routing - an optimization technique inspired by natural selection that helps find the most efficient delivery routes. It is especially useful for solving complex Traveling Salesman Problems (TSP) or Vehicle Routing Problems (VRP) in logistics.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">How It Works</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        A GA iteratively improves a population of possible delivery routes using evolutionary principles such as selection, crossover, and mutation.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Algorithm Steps</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Evolution Process</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        The algorithm uses evolutionary principles to iteratively improve route solutions.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Evolution Steps</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Benefits of Genetic Algorithms</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
...
function BusTransportOptimizationContent() {
    ...
    <div>
                <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-gray-200">Optimization Techniques</h3>
                <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                    {[
                        'Demand Prediction',
                        'Schedule Optimization',
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    UPLYFT analyzes urban mobility using historical geospatial data to optimize public transport by reducing overlapping routes and creating strategic transshipment nodes.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Purpose and Implementation</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Transshipment points are created by identifying strategic intersections where multiple routes naturally converge, making them ideal hubs for passenger transfers.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Transshipment Point Creation</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    ...
                    <p className="text-gray-300 mt-2 leading-7">
                        Our optimization algorithm follows a systematic approach to identify and implement transshipment nodes.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Optimization Algorithm</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Benefits of Transshipment Nodes</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
...
function SafetyAnalysisContent() {
    ...
    <p className="text-lg text-gray-300 mt-4 md:mt-6 leading-7 md:leading-8">
    Enhancing road safety through data-driven insights and predictive analytics.
    </p>
    </motion.header>
    <section className="space-y-8 md:space-y-12 mt-8 md:mt-12">
    <motion.div
    ...
    <p className="text-gray-300 mt-4 leading-7">
    UPLYFT's safety analysis tools help identify potential hazards, predict accident-prone areas, and suggest safer routes and driving behaviors.
    </p>
    </motion.div>
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    The Safety Analysis Service is an intelligent road safety system that utilizes clustering algorithms in Python to analyze historical accident data and identify high-risk areas. By recognizing accident hotspots and determining common causes—such as speeding, red-light violations, and hazardous weather conditions—the service helps city planners and traffic authorities implement targeted safety measures.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Key Features</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Our comprehensive safety analysis system includes several advanced features:
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Accident Hotspot Identification</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    ...
                    <p className="text-gray-300 mt-2 leading-7">
                        The system provides continuous monitoring of critical safety factors.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Monitoring Systems</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Impact & Benefits</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
                    ...
                    <p className="text-gray-300 mt-2 leading-7">
                        The Safety Analysis Service empowers city officials, traffic management teams, and policymakers with actionable insights to create safer and more efficient roadways for everyone.
                    </p>
                </div>
            </motion.div>
        </section>
...
function AuthenticationContent() {
    ...
    <p className="text-gray-300 mt-4 leading-7">
    UPLYFT uses a robust authentication system to ensure secure access to the platform and protect user data.
    </p>
    </motion.div>
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    Uplyft implements a role-based authentication system to ensure secure and restricted access to different sections of the platform. Users must log in or sign up to access any content. Based on their assigned roles, they have specific access permissions, and unauthorized access results in an error page.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">User Roles & Access Permissions</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Different user roles have specific access permissions within the UPLYFT platform.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Access Matrix</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                        ...
                        <pre className="overflow-x-auto p-6 text-sm font-mono bg-gray-950/50 rounded-b-xl">
                            <code className="language-bash text-gray-100">
                                {`User Role          | Accessible Pages              | Restricted Pages\n-------------------|-------------------------------|---------------------------\nPublic User        | Dashboard                      | Delivery Page, Bus Operator Page\nDelivery Partner   | Dashboard, Delivery Page      | Bus Operator Page\nBus Operator      | Dashboard, Bus Operator Page  | Delivery Page`}
                            </code>
                        </pre>
                    </motion.div>
                </div>
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Unauthorized Access Handling</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        UPLYFT has robust mechanisms to handle unauthorized access attempts.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Security Measures</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                        ...
                        <pre className="overflow-x-auto p-6 text-sm font-mono bg-gray-950/50 rounded-b-xl">
                            <code className="language-bash text-gray-100">
                                {`-  If a user attempts to access a page outside their permission scope, they will be redirected to an error page displaying a message: "You do not have access to this page."\n\n-  Users must be authenticated (logged in) to access any section of the platform.\n\n-  This access control mechanism ensures security, role-based access, and a streamlined user experience within Uplyft.`}
                            </code>
                        </pre>
                    </motion.div>
                </div>
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Authentication Flow</h3>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
...
function DatabaseContent() {
    ...
    <p className="text-gray-300 mt-4 leading-7">
    UPLYFT uses a combination of relational and NoSQL databases to handle different types of data and workloads efficiently.
    </p>
    </motion.div>
            <motion.div
                initial={{ opacity: 0 }}
            ...
            >
                ...
                <p className="text-gray-300 mt-4 leading-7">
                    Uplyft utilizes PostgreSQL as the primary database and Prisma as the ORM (Object-Relational Mapping) tool to manage and interact with the database efficiently. The system securely stores user data, retrieves bus details, and manages route creation, ensuring smooth and reliable data handling.
                </p>

                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Key Database Features</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Our database implementation provides several critical features for the Uplyft platform:
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Data Storage & Management</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Prisma ORM Implementation</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Prisma ORM provides a type-safe and intuitive way to interact with our PostgreSQL database.
                    </p>
                    <motion.div className="mt-3 rounded-xl border border-gray-800 bg-gray-900/50">
                        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
                            <span className="text-sm font-medium text-gray-400">Prisma Benefits</span>
                            <motion.button
                                type="button"
                                whileTap={{ scale: 0.95 }}
                                whileHover={{ scale: 1.05 }}
                ...
                <div className="mt-6">
                    <h3 className="text-xl font-semibold text-white">Database Schema Design</h3>
                    <p className="text-gray-300 mt-2 leading-7">
                        Our database schema is carefully designed to support all Uplyft operations with optimal performance.
                    </p>
                    <ul className="my-6 ml-6 list-disc space-y-3 marker:text-gray-400">
                        {[
